...
import Print from "@/components/UI/Shared/Print";
...
const OrderDetails = ({ id }) => {
  ...
  const orderData = async () => {
    setLoader(true);
    try {
      const response = await axiosInstance.get(`/my-order-details/${id}`);
  ...
  const handleSaveReview = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post(
        `/product-review?product_id=${itemId}`,
        formData
      );
      ...
      <div className="card-body">
        <div className="mb-5 mt-3">
          <div className="invoice-wrapper" style={{ display: "none" }}>
            ...
            <Print orderDetails={orderDetails} ref={contentRef} />
          </div>
          <div className="d-flex justify-content-end btnDiv container">
            <button
                ...
                <ul className="list-unstyled text-md-end">
                  ...
                  <li className="text-muted mt-2">
                    ...
                    {orderDetails?.payment_status === "Partially Paid" && (
                      <Badge bg="info" text="white" className="fw-bold">
                        Partially Paid
                      </Badge>
                    )}
                  </li>
                  ...
                  <Form.Group as={Row} controlId="message" className="mt-2">
                    ...
                    <Col sm="9">
                      ...
                      <small className="text-danger">
                        {errorMessage?.review ? errorMessage?.review[0] : ""}
                      </small>
                    </Col>
                  </Form.Group>
                </Form>
